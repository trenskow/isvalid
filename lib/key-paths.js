...
const keyPaths = (schema, formalizeOptions, options = {}) => {

	schema = (options.formalize, formalize)(schema, formalizeOptions);
	...
	return {
		...
		set: (keyPath, newSchema) => {
			...
			keyPath = keyPath || '';
			newSchema = (options.formalize || formalize)(newSchema, formalizeOptions);
