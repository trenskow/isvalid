...
var validateAny = function(data, schema, fn, keyPath, options) {
	...
	if (typeof schema.equal !== 'undefined') {
		return equals(data, schema.equal, function(equals) {
			if (equals) return validateCustom(data, schema, fn, keyPath, options);
			return fn(
				new ValidationError(
					keyPath,
					schema._nonFormalizedSchema,
...
module.exports = function(data, schema, fn, keyPath, options) {
	...
	if (options === undefined && typeof keyPath == 'object' && utils.name(keyPath.constructor) == 'Object') {
		options = keyPath;
		keyPath = undefined;
	}
